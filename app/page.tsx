            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="flex flex-col items-center gap-3 p-4">
                <div className="p-3 bg-purple-500/20 rounded-full text-purple-400">
                  {/* Crown/Premium Icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14" /></svg>
                </div>
                <h3 className="font-bold text-lg">Premium Imports</h3>
                <p className="text-sm text-gray-400">Hand-selected for vibrant color & health.</p>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 p-4 border-t md:border-t-0 md:border-l border-white/10">
                ...
                <p className="text-sm text-gray-400">What You See Is What You Get availability.</p>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 p-4 border-t md:border-t-0 md:border-l border-white/10">
                ...
                <p className="text-sm text-gray-400">Professional packaging for safe arrival.</p>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 bg-black/50 border border-gray-800 rounded-2xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
              ...
              <div className="w-full md:w-1/2 space-y-6">
                ...
                <div className="flex gap-4">
                  <Button asChild size="lg" className="rounded-full px-8 bg-white text-black hover:bg-gray-200 shadow-lg transition-transform hover:scale-105">
                    <Link
      ...
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {['Fish', 'Corals', 'Inverts', 'Supplies'].map((cat) => {
            // 💡 Conditional Logic: If it's supplies, use 'contain', otherwise use 'cover'
            const objectFitClass = cat === 'Supplies' ? 'object-contain' : 'object-cover';

            return (
              <Link
                key={cat}
                href={`/products/${cat.toLowerCase()}`}
                // Added 'bg-black' here to ensure the padding is definitely black
                className="group relative h-40 bg-black rounded-xl overflow-hidden flex items-center justify-center border border-gray-700 hover:border-blue-500 transition-all shadow-lg hover:shadow-blue-900/20"
              >
                {/* 🖼️ BACKGROUND IMAGE */}
                <Image
